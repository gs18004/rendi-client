...
export default function Review() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center gap-[31px] bg-black/40 px-4">
      <div className="flex h-[554px] w-[342px] flex-col items-center gap-[23px] rounded-[24px] bg-[#FAFAFA] px-10 pt-[30px]">
